...
def test_data
  ...
  @adoption_app_1 = AdoptionApp.create!(name: "Suzie", street_address: "1234 Elmo Road", city: "Hoboken", state: "New Jersey", zip_code: "85790", description: "I will spoil all the pets", pet_names: nil, status: nil)
  @adoption_app_2 = AdoptionApp.create!(name: "Fred", street_address: "4567 Grover Ave", city: "Tillamook", state: "Montana", zip_code: "45627", description: "I eat cats and honestly I am a terrible person", pet_names: nil, status: nil)
  @adoption_app_3 = AdoptionApp.create!(name: "Liam", street_address: "8910 Oscar Blvd", city: "Denver", state: "Colorado", zip_code: "80211", description: "Animals are awesome, adopt DONT shop!", pet_names: nil, status: nil)
