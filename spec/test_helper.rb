def load_test_data 
  ...
  @applicant_1 = Applicant.create!(name: "P Sherman", street_address: "42 Wallaby Way", city: "Sydney", state: "NSW", zipcode: "2307", description: "best pet parent duh", pets: "Drake, Portia, Stinky")

  @applicant_2 = Applicant.create!(name: "Clifford Red", street_address: "123 Greenwich", city: "New York City", state: "NY", zipcode: "10001", description: "10/10 pet parent duh", pets: "Drake, Portia, Stinky")
