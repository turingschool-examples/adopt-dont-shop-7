...
RSpec.describe Shelter, type: :model do
  ...
  describe "class methods" do
    ...
    describe '#shelters_pending_applications'do
      it 'extracts shelters with pending applications' do
  ...
  describe "instance methods" do
    ...
    describe "#reverse_order" do
      it 'returns shelter names in reverse alphabetical order' do
        expect(Shelter.reverse_order).to eq([@shelter_2, @shelter_3, @shelter_1])
      end
    end
  end
end
