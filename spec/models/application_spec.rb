...
RSpec.describe Application, type: :model do
  ...
  describe '#has_pending_pets' do
    it 'will check if the application has pending pets' do
      shelter_1 = Shelter.create!(name: "Aurora shelter", city: "Aurora, CO", foster_program: false, rank: 9)
      pet_1 = shelter_1.pets.create!(name: "Mr. Pirate", breed: "tuxedo shorthair", age: 5, adoptable: true)
      application = Application.create!(name: "John Smith", street_address: "376 Amherst Street", city: "Providence", state: "RI", zip_code: "02904", description: "I am a good person.", status: "Pending")
      application.add_pet(pet_1)
      application_pets = ApplicationPet.create!(pet_id: pet_1.id, application_id: application.id, application_pet_status: 1)
      expect(application.has_pending_pets).to eq(true)
    end
  end
end