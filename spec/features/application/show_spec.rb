...
RSpec.describe 'Application Show Page' do
  before(:each) do
    ...
    @stacy = Application.create(name: "Stacy Chapman", street_address: "1870 Canopy R", city: "Los Angeles", state: "CA", zip_code: 90001, description: "I grew up with dachshunds and felt really connected")
