...
RSpec.describe "the shelters index" do
  ...
  let!(:pet_1) {shelter_1.pets.create!(name: "Clawdia", breed: "shorthair", age: 3, adoptable: true)}
  let!(:pet_2) {shelter_3.pets.create!(name: "Lucille Bald", breed: "sphynx", age: 8, adoptable: true)}
  let!(:pet_3) {shelter_1.pets.create!(name: "Mr. Pirate", breed: "tuxedo shorthair", age: 5, adoptable: true)}
