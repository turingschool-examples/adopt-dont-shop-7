...
RSpec.describe "the shelters pets index" do
  ...
  let!(:pet_1) {Pet.create!(adoptable: true, age: 1, breed: "sphynx", name: "Bare-y Manilow", shelter_id: shelter.id)}
  ...
  let!(:pet_4) {Pet.create!(adoptable: true, age: 1, breed: "orange tabby shorthair", name: "Lasagna", shelter_id: shelter.id)}
