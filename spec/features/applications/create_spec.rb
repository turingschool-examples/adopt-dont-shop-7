...
RSpec.describe "application creation" do
  ...
  describe "new application" do
    ...
    it "if form is not filled in, will display an error and re-render the form" do
      ...
      expect(page).to have_current_path("/applications/new")
      expect(page).to have_content("Error: Name can't be blank, Street can't be blank, City can't be blank, State can't be blank, Zip can't be blank, Description can't be blank, Zip is the wrong length (should be 5 characters), State Please use 2 letters for the state abbreviation\nAdopt, Don't Shop!\nHome | Applications | Pets | Shelters | Veterinarians | Veterinary Offices\nStart a New Application\nName Street City State Zip Description")
    end
    ...
    it "if :state ro :zip are incorrecly formatted, will display an error and re-render the form" do
      ...
      expect(page).to have_current_path("/applications/new")
      expect(page).to have_content("Error: Zip is the wrong length (should be 5 characters)\nAdopt, Don't Shop!\nHome | Applications | Pets | Shelters | Veterinarians | Veterinary Offices\nStart a New Application\nName Street City State Zip Description")
    end
  end
end