...
RSpec.feature "the application show" do
  describe 'when visiting /applications/:id' do
    ...
    it 'US1: displays all application info' do
    ...
    it 'US4: displays a section to add a pet to the application' do
      visit "/applications/#{@application.id}"
    ...
    it 'US5: search for a pet by name to see matches and be able to adopt' do
      visit "/applications/#{@application.id}"
    ...
    it 'US6: see a section to submit my application' do
    ...
    it 'US7: does not display submit if there are no pets' do
      visit "/applications/#{@application.id}"
    ...
    it 'US8: search allows partial matches' do
      visit "/applications/#{@application.id}"
    ...
    it 'US9: search is case insensitive' do
      @pet3 = @shelter1.pets.create!(name: "zeus2", breed: "Great Dane", age: 3, adoptable: true)      
      visit "/applications/#{@application.id}"
