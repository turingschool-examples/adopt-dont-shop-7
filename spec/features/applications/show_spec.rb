...
before :each do 
  ...
  @application_1 = Application.create!(name: 'John Smith', address: '1234 Fake Street', city: 'Denver', state: 'CO', zip_code: 80202, description: 'Big Yak guy, but a dog will do', status: 'In Progress')
  @application_2 = Application.create!(name: 'Jane Doe', address: '5678 Wannabe Road', city: 'Boulder', state: 'CO', zip_code: 80301, description: 'I love cats!', status: 'In Progress')
  @application_3 = Application.create!(name: 'Joe Schmoe', address: '90210 Round Drive', city: 'Dallas', state: 'TX', zip_code: 75214, description: 'I like Turtles!', status: 'In Progress')
  ...
  describe 'when I visit the applications show page' do 
    it 'displays the application form' do 
      ...
      expect(page).to have_content(@application_pet_1.pet.name)
    end
  end
end