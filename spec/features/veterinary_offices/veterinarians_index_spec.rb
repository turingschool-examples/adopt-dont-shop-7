...
RSpec.describe "the veterinary offices veterinarians index" do
  ...
  let!(:not_on_call_vet) {Veterinarian.create!(name: "Taylor", review_rating: 10, on_call: false, veterinary_office_id: vet_office_1.id)}
  ...
  let!(:vet_4) {Veterinarian.create!(name: "John", review_rating: 2, on_call: true, veterinary_office_id: vet_office_2.id)}
