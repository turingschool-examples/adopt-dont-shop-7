...
RSpec.describe "the veterinarians index" do
  ...
  let!(:vet_1) {Veterinarian.create!(name: "Taylor", review_rating: 10, on_call: true, veterinary_office_id: vet_office.id)}
  let!(:vet_2) {Veterinarian.create!(name: "Jim", review_rating: 8, on_call: true, veterinary_office_id: vet_office.id)}
  ...
  it "only shows on call veterinarians" do
    vet_3 = Veterinarian.create!(name: "Sam", review_rating: 10, on_call: false, veterinary_office_id: vet_office.id)
