...
RSpec.describe "the pets index" do
  before :each do 
    ...
    @pet_2 = Pet.create(adoptable: true, age: 3, breed: "doberman", name: "Babe", shelter_id: @shelter.id)
    @pet_3 = Pet.create(adoptable: false, age: 2, breed: "saint bernard", name: "Elle", shelter_id: @shelter.id)
  end 
