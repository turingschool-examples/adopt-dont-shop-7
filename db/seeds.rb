...
applicant_1 = Applicant.create(name: "Ian", street_address: "4130 cleveland ave", city: "New Orleans", state: "louisiana", zip_code: 70119, description: "I wanna have cat", status: "Pending")
...
applicant_pet_2 = ApplicantPet.create(pet_id: pet_1.id, applicant_id: applicant_1.id)
