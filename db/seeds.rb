...
pet_lucille = Pet.create(name: "Lucille", adoptable: true, age: 1, breed: "Sphynx", shelter_id: shelter.id)
pet_lobster = Pet.create(name: "Lobster", adoptable: true, age: 3, breed: "Doberman", shelter_id: shelter.id)
pet_scooby = Pet.create(name: "Scooby", age: 2, breed: "Great Dane", adoptable: true, shelter_id: shelter.id)
pet_scrappy = Pet.create(name: "Scrappy", age: 1, breed: "Golden Retreiver", adoptable: true, shelter_id: shelter.id)
